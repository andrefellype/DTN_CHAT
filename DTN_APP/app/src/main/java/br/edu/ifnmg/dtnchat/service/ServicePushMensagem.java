...
import br.edu.ifnmg.dtnchat.ws.MensagensAsyncTask;

/**
 * Created by andrefellype on 17/01/18.
 */

public class ServicePushMensagem extends Service{
        ...
        class Worker extends Thread{
            ...
            public void run(){
                while(ativo){
                    ...
                    MensagensAsyncTask mensagensAsyncTask = new MensagensAsyncTask(context, usuario);
                    mensagensAsyncTask.execute(gson.toJson(usuario));
                }
                stopSelf(startId);
            }
        }
